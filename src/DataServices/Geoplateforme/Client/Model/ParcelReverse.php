...
class ParcelReverse
{
    ...
    /**
     * @return ParcelReverseProperties
     */
    public function getProperties(): ParcelReverseProperties
    {
        return $this->properties;
    }
    /**
     * @param ParcelReverseProperties $properties
     *
     * @return self
     */
    public function setProperties(ParcelReverseProperties $properties): self
    {

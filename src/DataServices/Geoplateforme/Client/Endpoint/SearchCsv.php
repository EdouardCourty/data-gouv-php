...
class SearchCsv extends \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Runtime\Client\Endpoint
{
    protected $accept;
    /**
     ...
     */
    public function __construct(\Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\SearchCsvPostBody $requestBody, array $accept = [])
    {
    ...
    {
        if ($this->body instanceof \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\SearchCsvPostBody) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (400 === $status && mb_strpos(strtolower($contentType), 'application/json') !== false)) {
            throw new \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Exception\SearchCsvBadRequestException($response);
        }
    }

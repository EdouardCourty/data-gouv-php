...
class PipelineGeocodeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PipelineGeocodeOptions::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PipelineGeocodeOptions::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PipelineGeocodeOptions();
        ...
        if (\array_key_exists('columns', $data)) {
            $values_1 = [];
            foreach ($data['columns'] as $value_1) {
                $values_1[] = $value_1;
            }
            $object->setColumns($values_1);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('columns') && null !== $data->getColumns()) {
            $values_1 = [];
            foreach ($data->getColumns() as $value_1) {
                $values_1[] = $value_1;
            }
            $dataArray['columns'] = $values_1;
        }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PipelineGeocodeOptions::class => false];
    }
}
...
class PoiReverseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PoiReverse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PoiReverse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PoiReverse();
        ...
        if (\array_key_exists('properties', $data)) {
            $object->setProperties($this->denormalizer->denormalize($data['properties'], \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PoiReverseProperties::class, 'json', $context));
        }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\PoiReverse::class => false];
    }
}
...
class ReverseCsvPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\ReverseCsvPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\ReverseCsvPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\ReverseCsvPostBody();
        ...
        if (\array_key_exists('result_columns', $data)) {
            $values_1 = [];
            foreach ($data['result_columns'] as $value_1) {
                $values_1[] = $value_1;
            }
            $object->setResultColumns($values_1);
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('resultColumns') && null !== $data->getResultColumns()) {
            $values_1 = [];
            foreach ($data->getResultColumns() as $value_1) {
                $values_1[] = $value_1;
            }
            $dataArray['result_columns'] = $values_1;
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Ecourty\DataGouv\DataServices\Geoplateforme\Client\Model\ReverseCsvPostBody::class => false];
    }
}
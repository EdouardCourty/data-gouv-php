...
class DatasetsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\Datasets::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\Datasets::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\Datasets();
        ...
        if (\array_key_exists('datasets', $data)) {
            ...
            foreach ($data['datasets'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\Dataset::class, 'json', $context);
            }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\Datasets::class => false];
    }
}
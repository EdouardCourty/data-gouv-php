...
class CatalogFacetsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\CatalogFacetsGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\CatalogFacetsGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\CatalogFacetsGetResponse200();
    ...
    {
        return [\Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\CatalogFacetsGetResponse200::class => false];
    }
}
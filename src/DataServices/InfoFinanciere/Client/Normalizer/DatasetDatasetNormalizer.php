...
class DatasetDatasetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDataset::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDataset::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDataset();
        ...
        if (\array_key_exists('attachments', $data)) {
            ...
            foreach ($data['attachments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDatasetAttachmentsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('fields', $data)) {
            ...
            foreach ($data['fields'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDatasetFieldsItem::class, 'json', $context);
            }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Model\DatasetDataset::class => false];
    }
}
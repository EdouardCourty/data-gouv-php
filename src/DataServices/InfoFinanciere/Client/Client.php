...
namespace Ecourty\DataGouv\DataServices\InfoFinanciere\Client;

class Client extends \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Runtime\Client\Client
{
    /**
    ...
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getDatasets(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetDatasets($queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ListExportFormatsUnauthorizedException
     * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ListExportFormatsInternalServerErrorException
     *
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     */
    public function listExportFormats(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ListExportFormats(), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportDatasetsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportDatasetsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function exportDatasets(string $format, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportDatasets($format, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportCatalogCSV($queryParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportCatalogDCAT($dcatApFormat, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetsFacetsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetsFacetsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getDatasetsFacets(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetDatasetsFacets($queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getRecords(string $datasetId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetRecords($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ListDatasetExportFormats($datasetId), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function exportRecords(string $datasetId, string $format, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportRecords($datasetId, $format, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsCSVUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsCSVInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function exportRecordsCSV(string $datasetId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportRecordsCSV($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsParquetUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\ExportRecordsParquetInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function exportRecordsParquet(string $datasetId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportRecordsParquet($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\ExportRecordsGPX($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getDataset(string $datasetId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetDataset($datasetId, $queryParameters, $accept), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordsFacetsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordsFacetsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getRecordsFacets(string $datasetId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetRecordsFacets($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetAttachmentsUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetDatasetAttachmentsInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getDatasetAttachments(string $datasetId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetDatasetAttachments($datasetId), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordUnauthorizedException
    * @throws \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Exception\GetRecordInternalServerErrorException
    *
    * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
    */
    public function getRecord(string $datasetId, string $recordId, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Endpoint\GetRecord($datasetId, $recordId, $queryParameters), $fetch);
    }
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        if (null === $httpClient) {
            ...
            $plugins = [];
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUriFactory()->createUri('https://www.info-financiere.gouv.fr/api/explore/v2.0');
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Ecourty\DataGouv\DataServices\InfoFinanciere\Client\Normalizer\JaneObjectNormalizer()];

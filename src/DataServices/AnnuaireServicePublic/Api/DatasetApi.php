...
namespace Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Api;

use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Client;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ClientException;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Exception\ApiException;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Exception\AuthenticationException;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Exception\AnnuaireServicePublicException;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Exception\ForbiddenException;
use Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Exception\NotFoundException;
...
final class DatasetApi
{
    ...
    */
    ...
    private function convertException(ClientException $e): AnnuaireServicePublicException
    {

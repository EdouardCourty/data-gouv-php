...
namespace Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client;

class Client extends \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Runtime\Client\Client
{
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetDatasets($queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ListExportFormats(), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportDatasetsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportDatasets($format, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportCatalogCSVUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportCatalogCSV($queryParameters), $fetch);
    }
    /**
     ...
     * } $queryParameters
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportCatalogDCATUnauthorizedException
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportCatalogDCAT($dcatApFormat, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetDatasetsFacets($queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\GetRecordsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetRecords($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ListDatasetExportFormatsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ListDatasetExportFormats($datasetId), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportRecordsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportRecords($datasetId, $format, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportRecordsCSV($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportRecordsParquetUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportRecordsParquet($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\ExportRecordsGPXUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\ExportRecordsGPX($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetDataset($datasetId, $queryParameters, $accept), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\GetRecordsFacetsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetRecordsFacets($datasetId, $queryParameters), $fetch);
    }
    /**
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Exception\GetDatasetAttachmentsUnauthorizedException
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetDatasetAttachments($datasetId), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Endpoint\GetRecord($datasetId, $recordId, $queryParameters), $fetch);
    }
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        if (null === $httpClient) {
            ...
            $plugins = [];
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUriFactory()->createUri('https://api-lannuaire.service-public.gouv.fr/api/explore/v2.1');
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Normalizer\JaneObjectNormalizer()];

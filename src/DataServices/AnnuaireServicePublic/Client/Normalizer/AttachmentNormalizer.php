...
class AttachmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Attachment::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Attachment::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Attachment();
        ...
        if (\array_key_exists('metas', $data)) {
            $object->setMetas($this->denormalizer->denormalize($data['metas'], \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\AttachmentMetas::class, 'json', $context));
            unset($data['metas']);
        }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Attachment::class => false];
    }
}
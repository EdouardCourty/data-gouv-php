...
class LinksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Links::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Links::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Links();
    ...
    {
        return [\Ecourty\DataGouv\DataServices\AnnuaireServicePublic\Client\Model\Links::class => false];
    }
}
...
class EtablissementPostMultiCriteresNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\Sirene\Client\Model\EtablissementPostMultiCriteres::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\Sirene\Client\Model\EtablissementPostMultiCriteres::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\Sirene\Client\Model\EtablissementPostMultiCriteres();
    ...
    {
        return [\Ecourty\DataGouv\DataServices\Sirene\Client\Model\EtablissementPostMultiCriteres::class => false];
    }
}
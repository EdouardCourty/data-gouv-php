...
class DatasetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Model\Dataset::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Model\Dataset::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Model\Dataset();
        ...
        if (\array_key_exists('dataset', $data)) {
            $object->setDataset($this->denormalizer->denormalize($data['dataset'], \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Model\DatasetDataset::class, 'json', $context));
            unset($data['dataset']);
        }
    ...
    {
        return [\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Model\Dataset::class => false];
    }
}
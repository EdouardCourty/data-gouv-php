...
namespace Ecourty\DataGouv\DataServices\CalendrierScolaire\Api;

use Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Exception\ApiException;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Exception\AuthenticationException;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Exception\CalendrierScolaireException;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Exception\ForbiddenException;
use Ecourty\DataGouv\DataServices\CalendrierScolaire\Exception\NotFoundException;
...
final class DatasetApi
{
    ...
    */
    ...
    {
        try {
            return $this->client->getRecords($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
    ...
    */
    ...
    {
        try {
            return $this->client->listDatasetExportFormats($datasetId, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportRecords($datasetId, $format, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportRecordsCSV($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportRecordsParquet($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportRecordsGPX($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->getRecordsFacets($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->getDatasetAttachments($datasetId, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->getRecord($datasetId, $recordId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }

    private function convertException(ClientException $e): CalendrierScolaireException
    {

...
final class CatalogApi
{
    ...
    */
    ...
    {
        try {
            return $this->client->getDatasets($queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
    ...
    {
        try {
            return $this->client->listExportFormats(\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportDatasets($format, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->exportCatalogCSV($queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->exportCatalogDCAT($dcatApFormat, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->getDatasetsFacets($queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    */
    ...
    {
        try {
            return $this->client->getDataset($datasetId, $queryParameters, \Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Client::FETCH_OBJECT, $accept);
        } catch (\Ecourty\DataGouv\DataServices\CalendrierScolaire\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }

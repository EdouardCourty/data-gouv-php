...
/**
 * Sub-client for the "Communes associées et déléguées" tag.
 */
final class CommunesAssocieesEtDelegueesApi
{
     ...
     *
     */
        public function getCommunesAssocieesDelegueesByCode(string $code, array $queryParameters = []): null|\Ecourty\DataGouv\DataServices\Geo\Client\Model\Commune
    {
        try {
            return $this->client->getCommunesAssocieesDelegueesByCode($code, $queryParameters, \Ecourty\DataGouv\DataServices\Geo\Client\Client::FETCH_OBJECT);
        } catch (\Ecourty\DataGouv\DataServices\Geo\Client\Exception\ClientException $e) {
            throw $this->convertException($e);
        }
    }

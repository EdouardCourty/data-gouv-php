...
class UnfeatureReuse extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{reuse}'], [$this->reuse], '/reuses/{reuse}/featured/');
    }

...
class PostMembershipRequestApiOrganizationsOrgOrgMembership extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
    protected $org;
    /**
     ...
     * }
     */
    public function __construct(string $org, \Ecourty\DataGouv\DataGouv\Client\Model\MembershipRequestWrite $payload, array $headerParameters = [])
    {
        $this->org = $org;
        $this->body = $payload;

...
class ListDataserviceFollowers extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * @param string $id
    ...
    {
        return str_replace(['{id}'], [$this->id], '/dataservices/{id}/followers/');
    }

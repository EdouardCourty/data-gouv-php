...
class GetSiteRdfCatalogFormat extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
    protected $_format;
    /**
    ...
    {
        return str_replace(['{_format}'], [$this->_format], '/site/catalog.{_format}');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['q', 'sort', 'page', 'tag', 'license', 'featured', 'geozone', 'granularity', 'temporal_coverage', 'access_type', 'organization', 'badge', 'organization_badge', 'owner', 'followed_by', 'format', 'schema', 'schema_version', 'topic', 'credit', 'dataservice', 'reuse', 'archived', 'deleted', 'private', 'page_size']);
        $optionsResolver->setRequired([]);
        $optionsResolver->setDefaults(['page' => 1, 'page_size' => 100]);

...
class ListOrganizationDiscussions extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{org}'], [$this->org], '/organizations/{org}/discussions/');
    }

...
class SpatialZones extends \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\BaseEndpoint implements \Ecourty\DataGouv\DataGouv\Client\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $ids, array $headerParameters = [])
    {
        $this->ids = $ids;
    ...
    {
        return str_replace(['{ids}'], [$this->ids], '/spatial/zones/{ids}/');
    }

...
class CommunityResourcePageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataGouv\Client\Model\CommunityResourcePage::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \get_class($data) === \Ecourty\DataGouv\DataGouv\Client\Model\CommunityResourcePage::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataGouv\Client\Model\CommunityResourcePage();
        ...
        if (\array_key_exists('data', $data)) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Ecourty\DataGouv\DataGouv\Client\Model\CommunityResource::class, 'json', $context);
            }
    ...
    {
        return [\Ecourty\DataGouv\DataGouv\Client\Model\CommunityResourcePage::class => false];
    }
}

...
class DataserviceReadHarvestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataGouv\Client\Model\DataserviceReadHarvest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataGouv\Client\Model\DataserviceReadHarvest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataGouv\Client\Model\DataserviceReadHarvest();
    ...
    {
        return [\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceReadHarvest::class => false];
    }
}
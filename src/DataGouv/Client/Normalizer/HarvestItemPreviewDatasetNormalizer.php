...
class HarvestItemPreviewDatasetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Ecourty\DataGouv\DataGouv\Client\Model\HarvestItemPreviewDataset::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Ecourty\DataGouv\DataGouv\Client\Model\HarvestItemPreviewDataset::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Ecourty\DataGouv\DataGouv\Client\Model\HarvestItemPreviewDataset();
        ...
        if (\array_key_exists('contact_points', $data)) {
            ...
            foreach ($data['contact_points'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewContactPointsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('harvest', $data)) {
            $object->setHarvest($this->denormalizer->denormalize($data['harvest'], \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewHarvest::class, 'json', $context));
        }
        ...
        if (\array_key_exists('resources', $data)) {
            ...
            foreach ($data['resources'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewResourcesItem::class, 'json', $context);
            }
            $object->setResources($values_4);
        }
        if (\array_key_exists('schema', $data)) {
            $object->setSchema($this->denormalizer->denormalize($data['schema'], \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewSchema::class, 'json', $context));
        }
        ...
        if (\array_key_exists('spatial', $data)) {
            $object->setSpatial($this->denormalizer->denormalize($data['spatial'], \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewSpatial::class, 'json', $context));
        }
        ...
        if (\array_key_exists('temporal_coverage', $data)) {
            $object->setTemporalCoverage($this->denormalizer->denormalize($data['temporal_coverage'], \Ecourty\DataGouv\DataGouv\Client\Model\DatasetPreviewTemporalCoverage::class, 'json', $context));
        }
    ...
    {
        return [\Ecourty\DataGouv\DataGouv\Client\Model\HarvestItemPreviewDataset::class => false];
    }
}
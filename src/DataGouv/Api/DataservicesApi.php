...
/**
 * Sub-client for the "dataservices" tag of the data.gouv.fr API.
 *
...
final class DataservicesApi
{
     ...
     *             }
     */
    public function listDataservices(array $queryParameters = [], array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataservicePage
    {
        try {
            return $this->client->listDataservices($queryParameters, $headerParameters, Client::FETCH_OBJECT);
     ...
     */
    public function createDataservice(\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceWrite $payload, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->createDataservice($payload, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->recentDataservicesAtomFeed(Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->deleteDataservice($dataservice, $queryParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     *             }
     */
    public function getDataservice(string $dataservice, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->getDataservice($dataservice, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     */
    public function updateDataservice(string $dataservice, \Ecourty\DataGouv\DataGouv\Client\Model\DataserviceWrite $payload, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->updateDataservice($dataservice, $payload, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     */
    public function dataserviceDatasetsCreate(string $dataservice, array $payload, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->dataserviceDatasetsCreate($dataservice, $payload, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     *             }
     */
    public function unfeatureDataservice(string $dataservice, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->unfeatureDataservice($dataservice, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     *             }
     */
    public function featureDataservice(string $dataservice, array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\DataserviceRead
    {
        try {
            return $this->client->featureDataservice($dataservice, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->rdfDataservice($dataservice, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->rdfDataserviceFormat($dataservice, $format, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->unfollowDataservice($id, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
     ...
     *             }
     */
    public function listDataserviceFollowers(string $id, array $queryParameters = [], array $headerParameters = []): ?\Ecourty\DataGouv\DataGouv\Client\Model\FollowPage
    {
        try {
            return $this->client->listDataserviceFollowers($id, $queryParameters, $headerParameters, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
    ...
    {
        try {
            return $this->client->followDataservice($id, Client::FETCH_OBJECT);
        } catch (ClientException $e) {
            throw $this->convertException($e);
        }
    }
